...
<td>
				<img src="./resources/images/${ad.aproductId}.jpg" style="width: 330px; height: 315px" /></td>

				<td><form action="AddToCart">

<input type="hidden" name="adpid" value=${ad.aproductId} />
Quantity<input type="text" name="d" value=1 /> 
<input type="submit" value="AddToCart" />
</form>
</td>
<a href="AddToCart?adpid=${ad.aproductId}">addCart</a>
